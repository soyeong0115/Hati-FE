  ...
  return (
    <div className="relative h-full">
      ...
      <img
        src={christmasHouse}
        alt="Christmas House"
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none z-0 w-[400px] h-auto"
      />

      {/* 하단 배경색 */}
      <div className="absolute bottom-0 left-0 w-full h-[25%] bg-[#FDF0DF] z-0" />
